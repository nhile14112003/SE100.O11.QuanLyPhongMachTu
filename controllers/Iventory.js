...
const addDrug = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "something went wrong when adding drug",
      });
  }
};
const getAllDrugs = async (req, res) => {
  ...
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "something went wrong when get data from Thuoc",
      });
    console.log(error);
    return [];
  }
...
const getDrugsBySearch = async (req, res) => {
  ...
  try {
    ...
    const searchResults = list.filter((thuoc) => {
      ...
      const matchTenThuoc =
        tenThuoc === "" ||
        normalizeText(thuoc.tenThuoc).includes(normalizeText(tenThuoc));
    ...
    const sortList = searchResults.sort((a, b) =>
      a.maThuoc.localeCompare(b.maThuoc)
    );
